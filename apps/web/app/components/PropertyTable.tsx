  ...
  return (
    <div className='flex flex-col h-full w-full bg-white dark:bg-[#050505] border-l border-zinc-200 dark:border-zinc-800 font-sans text-sm'>
      ...
      <div className='flex bg-gray-100 dark:bg-zinc-800 border-b border-zinc-300 dark:border-zinc-700 text-xs font-semibold text-zinc-600 dark:text-zinc-300 select-none'>
        ...
        <div className='flex-[2] px-2 py-1 flex items-center'>Value</div>
      </div>
          ...
          <tbody>
            {entries.map(([key, value]) => {
              ...
              return (
                <tr
                  key={key}
                  className='even:bg-zinc-50 dark:even:bg-zinc-900/40 hover:bg-blue-50 dark:hover:bg-blue-900/20 group'
                >
                  ...
                  >
                    <div className='flex items-center justify-between'>
                      <span
                        className={cn(isRowComplex && 'text-zinc-400 italic')}
                      >
                        {displayVal}
                      </span>
                      <ValueCopyButton
            ...
            {entries.length === 0 && (
              <tr>
                <td
                  colSpan={2}
                  className='px-2 py-4 text-center text-zinc-400 italic'
                >
                  Empty {type}
                </td>
              </tr>
